...
curl -SL https://github.com/twosigma/fastfreeze/releases/download/v1.2.0-rc1/fastfreeze-1.2.0-rc1.tar.xz | tar xJf -
...
fastfreeze/fastfreeze run --image-url file:/tmp/sleep-img.ff --container sleep-app -- sleep 60
```
...
RUN set -ex; \
  curl -SL https://github.com/twosigma/fastfreeze/releases/download/v1.2.0-rc1/fastfreeze-1.2.0-rc1.tar.xz | \
    tar xJf - -C /opt; \
